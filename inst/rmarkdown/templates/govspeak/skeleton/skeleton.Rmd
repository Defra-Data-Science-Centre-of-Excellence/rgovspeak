...
knitr::opts_chunk$set(
  ...
  # If you wish to see these in the preview set to TRUE. 
  # They must be FALSE when you generate the final MD file.
  cache = FALSE,
  warning = FALSE,
  message = FALSE,
...
Plot image files will be created at 960 x 640 @ 72 dpi (defined at the top of this document) **Do not change the image size as this is set to that which is accepted on gov.uk**.
Images will be saved in a folder called "images" within the same folder as this Rmd file.
